...
{%AspMarkupContainer 'CadastroVeiculo.aspx'}
{%AspFolderContainer 'Files'}
{%AspFolderContainer 'Images'}
{%TogetherDiagram 'ModelSupport_Lista1Entregar\default.txaPackage'}
{%File 'Propaganda.xml'}
{%AspMarkupContainer 'ThankYouForm.aspx'}
{%AspMarkupContainer 'WebForm1.aspx'}
{%AspFolderContainer 'registros'}
{%AspFolderContainer 'thumbs'}
{$R 'thumbs\tn_a.jpg' 'thumbs\tn_a.jpg'}

uses
  System.Reflection,
  System.Runtime.CompilerServices,
  Global in 'Global.pas' {Global.TGlobal: System.Web.HttpApplication},
  CadastroVeiculo in 'CadastroVeiculo.pas' {CadastroVeiculo.TWebForm2: System.Web.UI.Page},
  ThankYouForm in 'ThankYouForm.pas' {ThankYouForm.TWebForm1: System.Web.UI.Page},
