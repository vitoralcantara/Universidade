...
type
  ...
  strict private
    ...
    procedure SqlConnection1_InfoMessage(sender: System.Object; e: System.Data.SqlClient.SqlInfoMessageEventArgs);
  {$ENDREGION}
  strict private
...
begin
  ...
  // sqlSelectCommand1
  // 
  Self.sqlSelectCommand1.CommandText := 'select customerid, contactname,city' +
  ...
  Include(Self.SqlConnection1.InfoMessage, Self.SqlConnection1_InfoMessage);
  // 
  // sqlInsertCommand1
  // 
...
procedure TWebForm1.SqlConnection1_InfoMessage(sender: System.Object; e: System.Data.SqlClient.SqlInfoMessageEventArgs);
begin
